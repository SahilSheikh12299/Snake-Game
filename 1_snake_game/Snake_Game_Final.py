...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake Game By Sahil")
    ...
    def play_background_music(self):
        pygame.mixer.music.load('resources/metal_bg.mp3')
    ...
    def wall_collision(self,x1,y1):
        if x1>975 or x1 < 15 or y1> 775 or y1< 15:
            return True
        return False
    ...
    def render_background(self):
        image = pygame.image.load("resources/bg1.png")
        DEFAULT_IMAGE_SIZE = (1000, 800)
        bg = pygame.transform.scale(image, DEFAULT_IMAGE_SIZE)
